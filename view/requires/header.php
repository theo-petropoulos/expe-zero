...
<header class="justify-content-between pt-4" style="font-family: 'Roboto Mono', monospace;z-index:4">
        ...
        <!-- <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky"> -->
            <div>
            <nav class="navbar navbar-expand-md bg-white navbar-light uk-navbar-container">
                <div class="container container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav me-auto my-2 my-lg-0 justify-content-end" style="--bs-scroll-height: 100px;">
